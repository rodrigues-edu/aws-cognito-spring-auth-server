package com.example.cognito.service.impl;

import com.amazonaws.services.cognitoidp.AWSCognitoIdentityProvider;
import com.amazonaws.services.cognitoidp.model.*;
import com.example.cognito.configuration.AwsConfig;
import com.example.cognito.domain.enums.CognitoAttributesEnum;
import com.example.cognito.exception.FailedAuthenticationException;
import com.example.cognito.exception.InvalidPasswordException;
import com.example.cognito.exception.InvalidParameterException;
import com.example.cognito.exception.UserNotFoundException;
import com.example.cognito.exception.ServiceException;
import com.example.cognito.service.CognitoUserService;
...
public class CognitoUserServiceImpl implements CognitoUserService {
    ...
    public AdminListUserAuthEventsResult getUserAuthEvents(String username, int maxResult, String nextToken) {
        try {
            ...
            throw new InvalidParameterException(String.format("Amazon Cognito service encounters an invalid parameter %s", e.getMessage()), e);
        }
    }
